...
- chore(changelog): tighten git-cliff config and regenerate changelog (0d86708)## v0.2.0 - 2025-12-14
...
- chore(security): generate CycloneDX SBOM in CI and releases (1c11058)## v0.1.7 - 2025-12-13
...
- chore(github): added contributing.md (f341889)## v0.1.5 - 2025-12-11

### Features

- feat: simplify package init and centralize version (0a33223)## v0.1.1 - 2025-12-11
